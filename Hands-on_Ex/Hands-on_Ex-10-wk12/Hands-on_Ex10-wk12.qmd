---
title: "Hands-on Exercise 10 - week 12: Modelling Geographical Accessibility"
author: "Maaruni"
execute: 
  warning: false
date: 03/23/2024
...
-   what is the definition of accessibility? Is it in terms of how reachable it is from other regions?
...
All the values of the cost related fields are in **metres**. These datasets were downloaded from elearn.
...
Its interesting to use the entry and exit costs to eventually derive how accessible a region is. But the data that is prepared already has entry and exit costs. I wonder how these are measured and calculated before being prepared as the dataset provided at the start. This definitely has useful implications possibly in the world of IOT devices. These tactics may be used for finding how accessible certain regions of iot devices are accessible by network systems. It could identify blockages if certain data is entering specific regions of iot devices at a much slower rate due to higher "entry cost" and "exit cost".

## References

-   <https://r4gdsa.netlify.app/chap17.html>

-   <https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0272458>
